...
export class TuiFramework extends EventEmitter {
    constructor(program, options = {}, config) {
        ...
        this.options = {
            ...
            keybindings: {
                commandMode: ((_a = options.keybindings) === null || _a === void 0 ? void 0 : _a.commandMode) || ':',
                nextTab: ((_b = options.keybindings) === null || _b === void 0 ? void 0 : _b.nextTab) || ']',
                prevTab: ((_c = options.keybindings) === null || _c === void 0 ? void 0 : _c.prevTab) || '[',
                newTab: ((_d = options.keybindings) === null || _d === void 0 ? void 0 : _d.newTab) || 't',
                closeTab: ((_e = options.keybindings) === null || _e === void 0 ? void 0 : _e.closeTab) || 'x',
                quit: ((_f = options.keybindings) === null || _f === void 0 ? void 0 : _f.quit) || 'q',
            },
            layout: {
                tabBarHeight: ((_g = options.layout) === null || _g === void 0 ? void 0 : _g.tabBarHeight) || 3,
                commandBarHeight: ((_h = options.layout) === null || _h === void 0 ? void 0 : _h.commandBarHeight) || 3,
                statusBarHeight: ((_j = options.layout) === null || _j === void 0 ? void 0 : _j.statusBarHeight) || 2,
            },
        };
    ...
    updateTabBar() {
        ...
        const items = visibleTabs.map(tab => {
            var _a;
            const isActive = tab.id === ((_a = this.tabs[this.activeTabIndex]) === null || _a === void 0 ? void 0 : _a.id);
    ...
    updateStatus() {
        const activeTab = this.tabs[this.activeTabIndex];
        const tabInfo = `Tab ${this.activeTabIndex + 1}/${this.tabs.length}: ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.title) || 'None'}`;
    ...
    createFixedTabs() {
        ...
        if (this.config) {
            ...
            Object.keys(((_a = this.config.node) === null || _a === void 0 ? void 0 : _a.tests) || {}).forEach(testPath => {
                this.createTestTab(`Node: ${testPath}`, 'run', [testPath], nodeTab.id);
            });
            // Web tests - nested under Web Runtime
            Object.keys(((_b = this.config.web) === null || _b === void 0 ? void 0 : _b.tests) || {}).forEach(testPath => {
                this.createTestTab(`Web: ${testPath}`, 'run', [testPath], webTab.id);
            });
            // Golang tests - nested under Golang Runtime
            Object.keys(((_c = this.config.golang) === null || _c === void 0 ? void 0 : _c.tests) || {}).forEach(testPath => {
                this.createTestTab(`Golang: ${testPath}`, 'run', [testPath], golangTab.id);
            });
            // Python tests - nested under Python Runtime
            Object.keys(((_d = this.config.python) === null || _d === void 0 ? void 0 : _d.tests) || {}).forEach(testPath => {
...
export function createTui(program, options, config) {
