...
export class TestTreeDataProvider {
    ...
    getRuntimeItems() {
        ...
        return runtimes.map(({ label, runtime }) => new TestTreeItem(label, TreeItemType.Runtime, vscode.TreeItemCollapsibleState.Collapsed, { runtime }));
    }
    getTestItems(runtime) {
        ...
        return testNames.map(testName => new TestTreeItem(testName, TreeItemType.Test, vscode.TreeItemCollapsibleState.Collapsed, { runtime, testName }));
    }
