...
export class ProcessesTreeDataProvider {
    constructor() {
    ...
    getProcessItems() {
        ...
        if (!this.isConnected) {
            ...
            if (this.connectionAttempts >= this.maxConnectionAttempts) {
                items.push(new TestTreeItem("❌ Failed to connect to Docker process server", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
                ...
                // Add a retry button
                items.push(new TestTreeItem("Click to retry connection", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
                ...
                items.push(new TestTreeItem("To start the server, run:", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
                    description: "npm start in the project root",
                    info: true
                }, undefined, new vscode.ThemeIcon("info", new vscode.ThemeColor("testing.iconUnset"))));
            }
            else {
                items.push(new TestTreeItem("Connecting to Docker process server...", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
                ...
                items.push(new TestTreeItem("Click to manually refresh", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
        ...
        if (this.processes.length === 0) {
            return [
                new TestTreeItem("No Docker processes found", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
                    description: "Waiting for Docker containers to start",
                    noProcesses: true
                }, undefined, new vscode.ThemeIcon("info", new vscode.ThemeColor("testing.iconUnset"))),
                new TestTreeItem("Click to refresh", TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
        ...
        const items = [
            new TestTreeItem(`✅ Connected to Docker process server`, TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
        ...
        items.push(...this.processes.map(process => {
            ...
            return new TestTreeItem(label, TreeItemType.File, vscode.TreeItemCollapsibleState.None, {
