...
const BddPage = () => {
    ...
    return (React.createElement("div", { className: "container-fluid p-4", style: { backgroundColor: 'transparent', position: 'relative', zIndex: 10 } },
        React.createElement("div", { id: "starsContainer" },
            React.createElement("div", { id: "stars" })),
        React.createElement("div", { id: "sun" }),
        React.createElement("div", { id: "sunDay" }),
        React.createElement("div", { id: "sunSet" }),
        React.createElement("div", { id: "sky" }),
        React.createElement("div", { id: "horizon" }),
        React.createElement("div", { id: "horizonNight" }),
        React.createElement("div", { id: "moon" }),
        React.createElement("div", { id: "mountainRange" },
            React.createElement("div", { id: "mountain" })),
        React.createElement("div", { id: "water" }),
        React.createElement("div", { id: "waterReflectionContainer" },
            React.createElement("div", { id: "waterReflectionMiddle" })),
        React.createElement("div", { id: "waterDistance" }),
        React.createElement("div", { id: "darknessOverlaySky" }),
        React.createElement("div", { id: "darknessOverlay" }),
        React.createElement("div", { id: "oceanRippleContainer" },
            React.createElement("div", { id: "oceanRipple" })),
