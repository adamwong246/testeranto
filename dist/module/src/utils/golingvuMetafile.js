...
import { findGoFilesInProject, collectGoDependencies, } from "./golingvuMetafile/fileDiscovery";
...
`;
            ...
            const outputDirPath = path.join(projectRoot, "bundles", "golang", projectName, relativePath);
            const tempWrapperPath = path.join(outputDirPath, `${baseName}.golingvu.go`);
            ...
            const absoluteBinaryPath = path.join(path.dirname(tempWrapperPath), binaryName);
