...
export const Git = ({ adminMode }) => {
    const { id } = useParams();
    const [gitTree, setCommits] = useState({ commits: [], branches: [] });
    useEffect(() => {
        (async () => {
            octokit;
                ...
                React.createElement(Col, { sm: 3 },
                    React.createElement(Nav, { variant: "pills", className: "flex-column" },
                        React.createElement(Nav.Item, null,
                            React.createElement(NavLink, { to: `/commit/idk`, className: "nav-link" }, "ChromaPDX/kokomoBay")))),
                React.createElement(Col, { sm: 9 },
                    React.createElement(Tab.Content, null, fancyCommits.length && React.createElement(Gitgraph, null, (gitgraph) => {
