    ...
    return (React.createElement("div", { className: "d-flex min-vh-100" },
        React.createElement("div", { className: "bg-light border-end d-flex flex-column", style: {
            ...
            React.createElement(Nav, { variant: "pills", className: "flex-column p-2 flex-grow-1" },
                ...
                React.createElement(Nav.Link, { as: NavLink, to: "/processes", className: `${location.pathname.startsWith('/processes') ? 'active' : ''} d-flex align-items-center justify-content-center ${!isConnected ? 'text-muted pe-none' : ''}`, style: {
                        height: '40px',
                        width: '40px',
                    ...
                    } }, tutorialMode ? (React.createElement(OverlayTrigger, { placement: "right", overlay: React.createElement(Tooltip, { id: "processes-tooltip" }, "Processes") },
                    React.createElement("span", null, "\uD83D\uDCCA"))) : (React.createElement("span", null, "\uD83D\uDCCA"))),
                React.createElement(Nav.Link, { as: NavLink, to: "/git", className: `${location.pathname === '/git' ? 'active' : ''} d-flex align-items-center justify-content-center`, style: { height: '40px', width: '40px' } }, tutorialMode ? (React.createElement(OverlayTrigger, { placement: "right", overlay: React.createElement(Tooltip, { id: "git-tooltip" }, "Git Integration") },
                    React.createElement("span", null, "\uD83D\uDC19"))) : (React.createElement("span", null, "\uD83D\uDC19"))),
