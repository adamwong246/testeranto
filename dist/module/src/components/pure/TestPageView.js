            ...
            React.createElement(Tab.Content, { className: "mt-3" },
                React.createElement(Tab.Pane, { eventKey: "results" }, !testsExist ? (React.createElement(Alert, { variant: "danger", className: "mt-3" },
                    ...
                    React.createElement("div", { className: "mt-3" },
                        ...
                        React.createElement(Button, { variant: "outline-light", onClick: () => navigate(`/projects/${projectName}#${runtime}`) }, "View Build Logs")))) : testData ? (React.createElement("div", { className: "test-results" }, testData.givens.map((given, i) => (React.createElement("div", { key: i, className: "mb-4 card" },
                            ...
                            React.createElement("div", { className: "d-flex justify-content-between align-items-start" },
                                ...
                                then.artifacts && then.artifacts.length > 0 && (React.createElement("div", { className: "ms-3" },
                                    ...
                                    React.createElement("ul", { className: "list-unstyled" }, then.artifacts.map((artifact, ai) => (React.createElement("li", { key: ai },
                                        React.createElement("a", { href: `/testeranto/reports/${projectName}/${testName.split('.').slice(0, -1).join('.')}/${runtime}/${artifact}`, target: "_blank", className: "text-white", rel: "noopener noreferrer" }, artifact.split('/').pop()))))))))))))))))) : (React.createElement(Alert, { variant: "warning" }, "No test results found"))),
