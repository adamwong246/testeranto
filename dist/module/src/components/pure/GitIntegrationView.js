...
export const GitIntegrationView = ({ mode, setMode, fileService, setChanges, remoteStatus, changes, currentBranch, setIsLoading, isLoading, setCurrentBranch, setRemoteStatus, setError, loadChanges, loadGitStatus, error, getStatusBadgeVariant, commitSummary, setCommitSummary, commitDescription, setCommitDescription, handleSaveChanges, isCommitting, handleShareChanges, getSyncStatusVariant, handleGetUpdates, isPulling, isPushing, setIsPushing, getSyncStatusText, }) => {
