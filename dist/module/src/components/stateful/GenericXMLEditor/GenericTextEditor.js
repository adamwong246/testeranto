...
export const GenericTextEditor = ({ xmlTree, onUpdateTree }) => {
    ...
    return (React.createElement("div", { className: "h-100 d-flex flex-column align-items-center" },
        React.createElement("div", { style: { width: '80ch', maxWidth: '100%' } },
            React.createElement("div", { contentEditable: true, onInput: handleXmlChange, style: {
                    width: '80ch',
                    background: '#f8f9fa',
                    padding: '1rem',
