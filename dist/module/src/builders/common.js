...
export async function runBuild(getEsbuildConfig, getEntryPoints, builderName) {
    ...
    try {
        ...
        const buildOptions = getEsbuildConfig(config, entryPoints, configPath, bundlesDir);
        const result = await esbuild.build(buildOptions);
        const metafileDir = process.env.METAFILES_DIR ||
