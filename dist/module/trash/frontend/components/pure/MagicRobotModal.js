...
export const MagicRobotModal = ({ customMessage, isWebSocketConnected, messageOption, navigate, projectName, runtime, setCustomMessage, setMessageOption, setShowAiderModal, setShowToast, setToastMessage, setToastVariant, showAiderModal, testName, }) => {
    const fs = useFs();
    const onclick = async () => {
        try {
    ...
    return (React.createElement(Modal, { show: showAiderModal, onHide: () => setShowAiderModal(false), size: "lg", onShow: () => setMessageOption("default") },
        ...
        React.createElement(Modal.Footer, null,
            React.createElement(Button, { variant: "primary", onClick: onclick }, "Run Aider Command"))));
};
