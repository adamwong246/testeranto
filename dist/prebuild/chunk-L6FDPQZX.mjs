...
var Server_DockerCompose = class extends Server_TCP_Commands {
  ...
  async initializeAndStart() {
    const { setupDockerCompose } = await import("./dockerComposeGenerator-UJABXGZY.mjs");
...
var SINGLE_TEST_BLOCK = [NODE_TEST_STEPS];
...
var createLangConfig = (testFile, options) => {
  return {
...
var config = {
  ...
  golang: createLangConfig(golangConfig.testFile, golangConfig.options),
  python: createLangConfig(pythonConfig.testFile, pythonConfig.options),
  web: createLangConfig(webConfig.testFile, webConfig.options),
  node: createLangConfig(nodeConfig.testFile, nodeConfig.options)
};
