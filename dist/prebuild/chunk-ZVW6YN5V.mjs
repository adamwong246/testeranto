    ...
    for (const [testPath, testConfig] of Object.entries(tests)) {
      ...
      if (runtime === "node" || runtime === "python" || runtime === "web") {
        ...
        if (config.monitoring) {
          ...
          const wsPort2 = config.monitoring.websocketPort || 3002;
          staticAnalysisServiceConfig.environment.WS_PORT = wsPort2.toString();
          ...
          staticAnalysisServiceConfig.environment.MONITORING_WS_PORT = wsPort2.toString();
