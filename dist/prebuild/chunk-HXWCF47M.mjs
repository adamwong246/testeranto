...
var Server_TCP_WebSocketProcess = class extends Server_TCP_WebSocketBase {
  ...
  handleWebSocketMessageTypes(wsm, ws) {
    ...
    if (wsm.type === "getProcesses") {
      ...
      console.log(`[WebSocketProcess] Stored WebSocket connection for test ${testId}. Total connections: ${this.testConnections.size}`);
      console.log(`[WebSocketProcess] Looking for addTestToSchedulingQueue method...`);
      if (this.addTestToSchedulingQueue) {
        ...
        while (obj && !found) {
          ...
          for (const method of methods) {
            if (method === "addTestToSchedulingQueue") {
              ...
              this[method](testId, testName, runtime, ws);
              found = true;
              break;
            }
          }
