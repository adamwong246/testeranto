...
var golangDockerCmd, golangDockerFile;
var init_golangDocker = __esm({
  "src/server/runtimes/golang/golangDocker.ts"() {
    "use strict";
    init_nodeVersion();
    golangDockerCmd = `FROM ${baseNodeImage}
WORKDIR /workspace
...
var nodeDockerCmd, nodeDockerFile;
var init_nodeDocker = __esm({
  "src/server/runtimes/node/nodeDocker.ts"() {
    "use strict";
    init_nodeVersion();
    nodeDockerCmd = `FROM ${baseNodeImage}
WORKDIR /workspace
# Install libxml2-utils for xmllint and netcat-openbsd for network checks
RUN apk add --update --no-cache libxml2-utils netcat-openbsd
# Reinstall esbuild for Linux platform
...
var pythonDockerCmd, pythonDockerFile;
var init_pythonDocker = __esm({
  "src/server/runtimes/python/pythonDocker.ts"() {
    "use strict";
    init_nodeVersion();
    pythonDockerCmd = `FROM ${baseNodeImage}
WORKDIR /workspace
# Install libxml2-utils for xmllint and netcat-openbsd for network checks
RUN apk add --update --no-cache libxml2-utils netcat-openbsd
# Reinstall esbuild for Linux platform
...
var webDockerCmd, webDockerFile;
var init_webDocker = __esm({
  "src/server/runtimes/web/webDocker.ts"() {
    "use strict";
    init_nodeVersion();
    webDockerCmd = `FROM ${baseNodeImage}
WORKDIR /workspace
# Install libxml2-utils for xmllint and netcat-openbsd for network checks
RUN apk add --update --no-cache libxml2-utils netcat-openbsd
# Reinstall esbuild for Linux platform
