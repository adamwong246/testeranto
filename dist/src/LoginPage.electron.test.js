  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState = React7.useState, useEffect3 = React7.useEffect, useLayoutEffect2 = React7.useLayoutEffect, useDebugValue2 = React7.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef4 = React7.useRef, useEffect3 = React7.useEffect, useMemo3 = React7.useMemo, useDebugValue2 = React7.useDebugValue;
...
var react_jsx_testeranto_test_default = (testImplementations, testSpecifications, testInput) => {
  ...
  return Web_default(
    ...
    testImplementations,
    {
      ...
      andWhen: function(s2, actioner) {
        return actioner()(s2);
      },
      butThen: async function(s2) {
        return s2;
      },
      afterEach: async function(store2, ndx, artificer) {
        return {};
      },
      afterAll: (store2, artificer) => {
        return;
      }
    }
  );
...
function LoginPage() {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h2", null, "Welcome back!"), /* @__PURE__ */ import_react4.default.createElement("p", null, "Sign in and get to it."), /* @__PURE__ */ import_react4.default.createElement("form", null, /* @__PURE__ */ import_react4.default.createElement("input", { type: "email", value: selection.email, onChange: (e) => store.dispatch(actions.setEmail(e.target.value)) }), /* @__PURE__ */ import_react4.default.createElement("p", { id: "invalid-email-warning", className: "warning" }, selection.error === "invalidEmail" && "Something isn\u2019t right. Please double check your email format"), /* @__PURE__ */ import_react4.default.createElement("br", null), /* @__PURE__ */ import_react4.default.createElement("input", { type: "password", value: selection.password, onChange: (e) => store.dispatch(actions.setPassword(e.target.value)) }), /* @__PURE__ */ import_react4.default.createElement("p", null, selection.error === "credentialFail" && "You entered an incorrect email, password, or both."), /* @__PURE__ */ import_react4.default.createElement("br", null), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: selection.disableSubmit, onClick: (event) => {
