...
var app_redux_test_exports = {};
__export(app_redux_test_exports, {
  AppReduxTesteranto: () => AppReduxTesteranto
});
module.exports = __toCommonJS(app_redux_test_exports);
...
var ReduxTesteranto = (testInput, testSpecifications, testImplementations) => (0, import_Node.default)(
  testInput,
  testSpecifications,
  testImplementations,
  {
...
var AppReduxTesteranto = ReduxTesteranto(
  ...
  AppSpecification,
  {
    ...
    Thens: {
      TheEmailIs: (email) => (storeState) => import_chai.assert.equal(storeState.email, email),
      TheEmailIsNot: (email) => (storeState) => import_chai.assert.notEqual(storeState.email, email),
