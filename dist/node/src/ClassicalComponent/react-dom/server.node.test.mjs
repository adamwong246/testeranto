...
// node_modules/testeranto/node_modules/react-dom/cjs/react-dom-server.node.production.min.js
...
// node_modules/testeranto/node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js
...
// node_modules/testeranto/node_modules/react-dom/cjs/react-dom-server.node.development.js
...
// node_modules/testeranto/node_modules/react-dom/server.node.js
...
var node_default = (testImplementations, testSpecifications, testInput) => {
  return Node_default(testInput, testSpecifications, testImplementations, {
    // beforeAll: async (
    //   prototype,
    //   artificer
    // ): Promise<ISubject> => {
...
// src/ClassicalComponent/react-dom/server.node.test.tsx
var snapshot = `<div style="border:3px solid green"><h1>Hello Marcus</h1><pre id="theProps">{}</pre><p>foo: </p><pre id="theState">{&quot;count&quot;:0}</pre><p>count: 0 times</p><button id="theButton">Click</button></div>`;
...
export {
  server_node_test_default as default
};
