...
export declare class MockCore<I extends Ibdd_in_any, O extends Ibdd_out_any, M = unknown> extends TesterantoCore<I, O, M> {
    constructor(input: I["iinput"], testSpecification: ITestSpecification<I, O>, testImplementation: ITestImplementation<I, O, M>, testResourceRequirement?: ITTestResourceRequest, testAdapter?: Partial<ITestAdapter<I>>, uberCatcher?: (cb: () => void) => void);
