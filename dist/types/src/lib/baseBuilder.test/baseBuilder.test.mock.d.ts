 ...
 */
export declare class MockBaseBuilder<I extends Ibdd_in_any, O extends Ibdd_out_any, SuiteExtensions = {}, GivenExtensions = {}, WhenExtensions = {}, ThenExtensions = {}, CheckExtensions = {}> extends BaseBuilder<I, O, SuiteExtensions, GivenExtensions, WhenExtensions, ThenExtensions> {
