...
const fileHashes = {};
const changes = {};
class PM_WithProcesses extends PM_WithGit_js_1.PM_WithGit {
    ...
    async metafileOutputs(platform) {
        ...
        if (!fs_1.default.existsSync(metafilePath)) {
            if (platform === "python") {
                console.log(ansi_colors_1.default.yellow(ansi_colors_1.default.inverse(`Pitono metafile not found yet: ${metafilePath}`)));
            }
            return;
        }
        let metafile;
        ...
        if (!outputs || typeof outputs !== 'object') {
            console.log(ansi_colors_1.default.yellow(ansi_colors_1.default.inverse(`No outputs found in metafile at ${metafilePath}`)));
            return;
        }
    ...
    async start() {
        ...
        const { nodeEntryPoints, webEntryPoints, pureEntryPoints, pythonEntryPoints, golangEntryPoints, } = (0, utils_1.getRunnables)(this.configs.tests, this.name);
        [
            [
                nodeEntryPoints,
                this.launchNode,
            ...
            Object.entries(eps).forEach(async ([inputFile, outputFile]) => {
                ...
                try {
                    ...
                    if (fs_1.default.existsSync(outputFile)) {
                        ...
                        console.log(ansi_colors_1.default.yellow(ansi_colors_1.default.inverse(`File not found, skipping watch: ${outputFile}`)));
                    }
                }
                catch (e) {
                    console.error(e);
            ...
            if (runtime === "python") {
                ...
                const checkFileExists = () => {
                    if (fs_1.default.existsSync(metafile)) {
                        console.log(ansi_colors_1.default.green(ansi_colors_1.default.inverse(`Pitono metafile found: ${metafile}`)));
    ...
    checkQueue() {
        ...
        const runnables = (0, utils_1.getRunnables)(this.configs.tests, this.name);
        let dest;
        switch (runtime) {
            case "node":
