...
class PM_WithProcesses extends PM_WithGit_js_1.PM_WithGit {
    constructor(configs, name, mode) {
        ...
        this.receiveFeaturesV2 = (reportDest, srcTest, platform) => {
            ...
            testReport.features
                ...
                const isUrl = (0, utils_js_2.isValidUrl)(featureStringKey);
                if (isUrl) {
                    ...
                    if (u.protocol === "file:") {
                        ...
                        (0, utils_js_2.writeFileAndCreateDir)(newPath, body);
    ...
    async metafileOutputs(platform) {
        ...
        Object.keys(outputs).forEach(async (k) => {
            ...
            if (entrypoint) {
                ...
                const changeDigest = await (0, utils_js_2.filesHash)(addableFiles);
    ...
    findTestNameByEntrypoint(entrypoint, platform) {
        const runnables = (0, utils_js_1.getRunnables)(this.configs.tests, this.name);
        let entryPointsMap;
        switch (platform) {
            case "node":
    ...
    async start() {
        ...
        try {
            this.browser = await puppeteer_core_1.default.launch(utils_js_2.puppeteerConfigs);
        }
        catch (e) {
            console.error(e);
        ...
        console.log(ansi_colors_1.default.blue(`Runnables for ${this.name}:\n` +
