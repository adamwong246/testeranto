...
const SkriboPage = () => {
    const [code, setCode] = (0, react_1.useState)('// Write your code here\nfunction hello() {\n  console.log("Hello, world!");\n}');
    const [language, setLanguage] = (0, react_1.useState)('javascript');
    const [fileTreeWidth, setFileTreeWidth] = (0, react_1.useState)(250);
    const [editorWidth, setEditorWidth] = (0, react_1.useState)(600);
    const [previewWidth, setPreviewWidth] = (0, react_1.useState)(400);
    const [isResizing, setIsResizing] = (0, react_1.useState)(false);
    const [resizeType, setResizeType] = (0, react_1.useState)(null);
    ...
    const [xmlTree, setXmlTree] = (0, react_1.useState)({
        id: 'root',
        type: 'svg',
        ...
        const loadFileTree = async () => {
            ...
            try {
                ...
                if (isDevelopment) {
                    ...
                    try {
                        const { getFileService } = await Promise.resolve().then(() => __importStar(require('../../services/FileService')));
    ...
    const renderFileTree = (items) => {
        return (react_1.default.createElement("ul", { style: { listStyle: 'none', paddingLeft: '0' } }, items.map((item, index) => (react_1.default.createElement("li", { key: index, style: { marginBottom: '0.25rem' } },
            react_1.default.createElement("div", { className: "d-flex align-items-center", style: { cursor: item.type === 'file' ? 'pointer' : 'default' }, onClick: () => {
                    if (item.type === 'file') {
                        loadFileContent(item.path);
                    }
                } },
                react_1.default.createElement("span", { className: "me-1" }, item.type === 'folder' ? '📁 ' : '📄 '),
                react_1.default.createElement("span", { className: "small" }, item.name)),
            item.type === 'folder' && item.children && (react_1.default.createElement("div", { style: { marginLeft: '1rem' } }, renderFileTree(item.children))))))));
    };
    return (react_1.default.createElement("div", { style: { height: '100%', width: '100%', overflow: 'hidden' } },
        react_1.default.createElement("div", { ref: containerRef, style: {
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("div", { className: "d-flex justify-content-between align-items-center mb-2" },
                    react_1.default.createElement("h6", null, "Files"),
                    react_1.default.createElement("button", { className: "btn btn-sm btn-outline-secondary", onClick: () => window.location.reload(), title: "Refresh" }, "\u21BB")),
                isLoading ? (react_1.default.createElement("div", { className: "text-center" },
                    react_1.default.createElement("div", { className: "spinner-border spinner-border-sm", role: "status" },
                        react_1.default.createElement("span", { className: "visually-hidden" }, "Loading...")))) : (react_1.default.createElement(react_1.default.Fragment, null,
                    currentPath && (react_1.default.createElement("div", { className: "small text-muted mb-2" },
                        "Current: ",
                        currentPath)),
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("div", { className: "d-flex justify-content-between align-items-center mb-2 p-2" },
                    react_1.default.createElement("div", { className: "btn-group", role: "group" },
                        react_1.default.createElement("button", { type: "button", className: "btn btn-sm btn-outline-secondary", onClick: handleUndo, disabled: !canUndo, title: "Undo" }, "\u21B6"),
                        react_1.default.createElement("button", { type: "button", className: "btn btn-sm btn-outline-secondary", onClick: handleRedo, disabled: !canRedo, title: "Redo" }, "\u21B7")),
                    react_1.default.createElement("select", { className: "form-select form-select-sm", style: { width: '120px' }, value: language, onChange: (e) => setLanguage(e.target.value) },
                        ...
                        react_1.default.createElement("option", { value: "xml" }, "XML"))),
                react_1.default.createElement("div", { style: { flex: 1, border: '1px solid #ccc', borderRadius: '4px', overflow: 'hidden' } },
                    react_1.default.createElement(react_2.default, { height: "100%", defaultLanguage: "javascript", language: language, value: code, onChange: handleEditorChange, onMount: handleEditorDidMount, theme: "vs-dark", options: {
                            fontSize: 14,
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement("h5", null, "Preview"),
                react_1.default.createElement(GenericPreview_1.GenericPreview, { xmlTree: xmlTree, selectedNodeId: selectedNodeId, hiddenNodes: hiddenNodes, renderPreview: (node, isSelected, eventHandlers) => {
                        if (node.type === 'rect') {
                            return (react_1.default.createElement("rect", Object.assign({ key: node.id }, node.attributes, { stroke: isSelected ? 'blue' : 'none', strokeWidth: isSelected ? '2' : '0' }, eventHandlers)));
                        }
                        return null;
                    } })))));
};
