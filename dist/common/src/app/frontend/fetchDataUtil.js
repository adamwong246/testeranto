...
exports.fetchDataUtil = void 0;
/* eslint-disable @typescript-eslint/no-unused-vars */
const api_1 = require("./api");
const fetchDataUtil = async (testResponse, metafileRes, testPath, setLogs, projectName, setSummary, setErrorCounts, setTestsExist, runtime) => {
    var _a;
...
exports.fetchDataUtil = fetchDataUtil;
