...
const GenericTextEditor = ({ xmlTree, onUpdateTree }) => {
    ...
    return (react_1.default.createElement("div", { className: "h-100 d-flex flex-column align-items-center p-1" },
        react_1.default.createElement("div", { style: { width: '100%', maxWidth: '100%', flex: 1, display: 'flex', flexDirection: 'column' } },
            react_1.default.createElement("textarea", { value: xmlContent, onChange: handleXmlChange, style: {
                    width: '100%',
                    background: '#f8f9fa',
                    padding: '0.5rem',
            ...
            error && (react_1.default.createElement(react_bootstrap_1.Alert, { variant: "danger", className: "mt-1 py-1" },
                react_1.default.createElement("small", null, error))),
            react_1.default.createElement(react_bootstrap_1.Button, { variant: "primary", onClick: applyChanges, className: "mt-1 py-0", disabled: !!error, size: "sm" }, "Apply"))));
};
