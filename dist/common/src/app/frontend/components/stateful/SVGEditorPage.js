...
exports.SVGEditorPage = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable @typescript-eslint/no-unused-vars */
const react_1 = __importStar(require("react"));
const SVGAttributesEditor_1 = require("./SVGEditor/SVGAttributesEditor");
const SVGElementForm_1 = require("./SVGEditor/SVGElementForm");
const GenericXMLEditorPage_1 = require("./GenericXMLEditorPage");
const SVGPreview_1 = require("./SVGEditor/SVGPreview");
const SVGEditorPage = () => {
    const initialTree = {
        id: "root",
        type: "svg",
    ...
    const [svgTree, setSvgTree] = (0, react_1.useState)(initialTree);
    ...
    const [snapToGrid, setSnapToGrid] = (0, react_1.useState)(false);
    const [hiddenNodes, setHiddenNodes] = (0, react_1.useState)(new Set());
    const [dragInfo, setDragInfo] = (0, react_1.useState)({
        isDragging: false,
        nodeId: null,
    });
    // Find a node by ID
    ...
    // Handle drag start
    const handleDragStart = (0, react_1.useCallback)((nodeId) => {
    ...
    // Move a node
    const moveNode = (0, react_1.useCallback)((nodeId, newParentId, index) => {
        setSvgTree((prevTree) => {
            const newTree = JSON.parse(JSON.stringify(prevTree));
    ...
    const handleMove = (0, react_1.useCallback)(() => {
    ...
    const renderSVGPreview = (node, isSelected, eventHandlers) => {
        ...
        if (type === 'text' || type === 'tspan') {
            return react_1.default.createElement(type, Object.assign(Object.assign(Object.assign({ key: node.id }, attributes), eventHandlers), { style }), textContent, ...childElements);
        }
        ...
        return react_1.default.createElement(elementType, Object.assign(Object.assign(Object.assign({ key: node.id }, attributes), eventHandlers), { style }), childElements);
    };
    ...
    const renderSVGAttributeEditor = (node, onUpdateAttributes, onUpdateTextContent) => {
        ...
        if (["circle", "rect", "g"].includes(node.type)) {
            return (react_1.default.createElement(SVGElementForm_1.SVGElementForm, { elementType: node.type, attributes: node.attributes, onChange: onUpdateAttributes }));
        }
        else {
            return (react_1.default.createElement(SVGAttributesEditor_1.SVGAttributesEditor, { node: node, onUpdateAttributes: onUpdateAttributes, onUpdateTextContent: onUpdateTextContent }));
        }
    };
    ...
    const SvgCustomPreview = () => {
        ...
        return (react_1.default.createElement(SVGPreview_1.SVGPreview, { svgTree: svgTree, editMode: editMode, showGrid: showGrid, selectedNodeId: selectedNodeId, onNodeInteraction: (nodeId, updates) => {
    ...
    return (react_1.default.createElement(GenericXMLEditorPage_1.GenericXMLEditorPage, { initialTree: initialTree, renderPreview: renderSVGPreviewWithControls, attributeEditor: renderSVGAttributeEditor, nodeTypes: svgNodeTypes, onAddNode: createSVGNode }));
};
exports.SVGEditorPage = SVGEditorPage;
