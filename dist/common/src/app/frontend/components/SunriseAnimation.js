...
const SunriseAnimation = ({ active }) => {
    ...
    if (!active)
        return null;
    return (react_1.default.createElement("div", { id: "sunrise", style: {
            width: '100vw',
            height: '100vh',
            position: 'fixed',
            top: 0,
        ...
        react_1.default.createElement("div", { id: "daily-bg", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        "Stars Container",
        react_1.default.createElement("div", { id: "starsContainer", style: {
                perspective: 350,
            ...
            react_1.default.createElement("div", { id: "stars", style: {
        ...
        react_1.default.createElement("div", { id: "sun", style: {
                position: 'absolute',
                top: 0,
                left: '50%',
        ...
        react_1.default.createElement("div", { id: "sunDay", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "sunSet", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "sky", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "horizon", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "horizonNight", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "moon", style: {
                position: 'absolute',
                top: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "water", style: {
                overflow: 'hidden',
                position: 'absolute',
                bottom: 0,
                left: 0,
        ...
        react_1.default.createElement("div", { id: "waterReflectionContainer", style: {
                perspective: 30,
            ...
            react_1.default.createElement("div", { id: "waterReflectionMiddle", style: {
                    position: 'absolute',
                    top: 0,
                    left: '-50%',
                    width: '200%',
        ...
        react_1.default.createElement("div", { id: "waterDistance", style: {
                position: 'absolute',
                bottom: 0,
                left: 0,
                width: '100%',
        ...
        react_1.default.createElement("div", { id: "darknessOverlaySky", style: {
                backgroundColor: '#000',
        ...
        react_1.default.createElement("div", { id: "darknessOverlay", style: {
                backgroundColor: '#000',
        ...
        react_1.default.createElement("div", { id: "oceanRipple", style: {
...
exports.default = SunriseAnimation;
