...
const utils_js_2 = require("../../PM/utils.js");
    ...
    constructor() {
        ...
        this.launchPure = async (src, dest) => {
            ...
            const purePromise = (async () => {
                ...
                const logs = (0, utils_js_2.createLogStreams)(reportDest, "pure");
                try {
                    await Promise.resolve(`${`${builtfile}?cacheBust=${Date.now()}`}`).then(s => __importStar(require(s))).then((module) => {
                        return module.default
                            ...
                            return defaultModule
                                ...
                                (0, utils_js_2.statusMessagePretty)(results.fails, src, "pure");
                            ...
                            (0, utils_js_2.statusMessagePretty)(-1, src, "pure");
                            throw e2;
                        });
                    });
                }
        ...
        this.launchNode = async (src, dest) => {
            ...
            const nodePromise = (async () => {
                try {
                    ...
                    const logs = (0, utils_js_2.createLogStreams)(reportDest, "node");
        ...
        this.launchPython = async (src, dest) => {
            ...
            const pythonPromise = (async () => {
                try {
                    ...
                    const logs = (0, utils_js_2.createLogStreams)(reportDest, "python");
        ...
        this.launchGolang = async (src, dest) => {
            ...
            const golangPromise = (async () => {
                try {
                    ...
                    const logs = (0, utils_js_2.createLogStreams)(reportDest, "golang");
        ...
        return new Promise((resolve, reject) => {
            ...
            child.on("close", (code) => {
                ...
                if (exitCode === 0) {
                    ...
                    (0, utils_js_2.statusMessagePretty)(0, src, runtime);
                    resolve();
                }
                else {
                    ...
                    (0, utils_js_2.statusMessagePretty)(exitCode, src, runtime);
            ...
            child.on("error", (e) => {
                ...
                this.bddTestIsNowDone(src, -1);
                (0, utils_js_2.statusMessagePretty)(-1, src, runtime);
                reject(e);
            });
        });
    }
