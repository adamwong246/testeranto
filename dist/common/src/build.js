...
const { pythonEntryPoints, nodeEntryPoints, nodeEntryPointSidecars, webEntryPoints, webEntryPointSidecars, pureEntryPoints, pureEntryPointSidecars, golangEntryPoints, golangEntryPointSidecars, } = (0, utils_1.getRunnables)(config.tests, testName);
...
if (golangFiles.length > 0) {
    ...
    await fs.promises.mkdir(path_1.default.dirname(metafilePath), { recursive: true });
