...
const problemScene = makeScene2D('problem', function* (view) {
    ...
    const problemDuration = durations_json_1.default.problem;
...
const solutionScene = makeScene2D('solution', function* (view) {
    ...
    yield* chain(waitFor(durations_json_1.default.solution * 0.2), all(text.opacity(1, 0.5), text.scale(1.1, 0.3).to(1, 0.3)));
