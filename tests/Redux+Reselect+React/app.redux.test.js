...
export const AppReduxTesteranto = ReduxTesteranto({
    ...
    return [
        Suite.Default("Testing the Redux store", [
            Given.AnEmptyState([`hello`], [
                When.TheEmailIsSetTo("adam@email.com")
            ], [
                Then.TheEmailIs("adam@email.com")
            ]),
            Given.AStateWithEmail([`hello`], [], [
                Then.TheEmailIsNot("adam@email.com"),
                Then.TheEmailIs("bob@mail.com"),
            ], "bob@mail.com"),
            Given.AnEmptyState([`hello`], [When.TheEmailIsSetTo("hello"), When.TheEmailIsSetTo("aloha")], [Then.TheEmailIs("aloha")]),
            Given.AnEmptyState([`aloha`, `hello`], [], [Then.TheEmailIs("")]),
            Given.AnEmptyState([`aloha`, `hello`], [When.TheEmailIsSetTo("hey there")], [Then.TheEmailIs("hey there")]),
        ], [
        // Check.AnEmptyState(
        //   "imperative style",
        //   [`aloha`],
