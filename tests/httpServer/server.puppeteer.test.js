...
export const ServerHttpPuppeteerTesteranto = PuppeteerHttpTesteranto({
    ...
    return [
        Suite.Default("Testing the Server with Puppeteer", [
            Given.AnEmptyState([], [], [Then.TheStatusIs("some great status")]),
            Given.AnEmptyState([], [When.PostToStatus("goodbye")], [Then.TheStatusIs("aloha")]),
            Given.AnEmptyState([myFeature], [When.PostToStatus("hello"), When.PostToStatus("aloha")], [Then.TheStatusIs("aloha")]),
            Given.AnEmptyState([], [], [Then.TheNumberIs(0)]),
