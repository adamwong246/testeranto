      ...
      >
        ...
        <Nav variant="pills" className="flex-column p-0 flex-grow-1">
              ...
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="help-tooltip">
                    Chat with Helpo, the helpful robot.
                  </Tooltip>
                }
              >
                <span>helpo</span>
          ...
          <Nav.Link
            as={NavLink}
            to="/processes"
            className={`${location.pathname.startsWith("/processes") ? "active" : ""
              } d-flex align-items-center justify-content-center ${!hasAnimated ? "navbar-attention-3" : ""
              }`}
            // style={{
            //   height: '40px',
            //   width: '40px',
          ...
          <Nav.Link
            as={NavLink}
            to="/svg-editor"
            className={`${location.pathname === "/svg-editor" ? "active" : ""
              } d-flex align-items-center justify-content-center`}
          >
            {tutorialMode ? (
              <OverlayTrigger
                placement="right"
                overlay={<Tooltip id="svg-editor-tooltip">svg editor</Tooltip>}
              >
                <span>vektoro</span>
              </OverlayTrigger>
            ) : (
          ...
          <Nav.Link
            as={NavLink}
            to="/drato"
            className={`${location.pathname === "/drato" ? "active" : ""
              } d-flex align-items-center justify-content-center`}
          >
            {tutorialMode ? (
              <OverlayTrigger
          ...
          <Nav.Link
            as={NavLink}
            to="/grafeo"
            className={`${location.pathname === "/grafeo" ? "active" : ""
              } d-flex align-items-center justify-content-center`}
          >
            {tutorialMode ? (
              <OverlayTrigger
                placement="right"
                overlay={<Tooltip id="grafeo-tooltip">GraphML editor</Tooltip>}
              >
                <span>grafeo</span>
              </OverlayTrigger>
            ) : (
          ...
          <Nav.Link
            as={NavLink}
            to="/skribo"
            className={`${location.pathname === "/skribo" ? "active" : ""
              } d-flex align-items-center justify-content-center`}
          >
            {tutorialMode ? (
              <OverlayTrigger
                placement="right"
                overlay={<Tooltip id="skribo-tooltip">Code editor</Tooltip>}
              >
                <span>skribo</span>
              </OverlayTrigger>
            ) : (
          ...
          >
            {location.pathname === "/helpo" ? (
              <div>
                ...
                <p>
                  Welcome to the Helpo documentation. Here you can find
                  information about using Testeranto.
                </p>
                <h2>Getting Started</h2>
                <p>
                  Start by creating a project and writing your first test cases.
                </p>
                <h2>Features</h2>
                <ul>
