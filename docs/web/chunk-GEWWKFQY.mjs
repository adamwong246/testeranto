...
var getWebSocketTransportClass = async () => {
  return isNode ? (await import("./NodeWebSocketTransport-KIPN7CTU.mjs")).NodeWebSocketTransport : (await import("./BrowserWebSocketTransport-AJ3WEQWR.mjs")).BrowserWebSocketTransport;
};
