    ...
    if (true) {
      (function() {
          ...
          switch (inst.tag) {
            ...
            case "INSTANCE": {
              ...
              if (inst.children && inst.children.length) {
                for (var i2 = 0; i2 < inst.children.length; i2++) {
                  var renderedChild = toJSON(inst.children[i2]);
        ...
        function flatten(arr) {
          ...
          while (stack.length) {
            var n2 = stack.pop();
            while (n2.i < n2.array.length) {
              var el = n2.array[n2.i];
              n2.i += 1;
              if (isArray(el)) {
                stack.push(n2);
                stack.push({
            ...
            toJSON: function() {
              ...
              if (container.children && container.children.length) {
                for (var i2 = 0; i2 < container.children.length; i2++) {
                  var renderedChild = toJSON(container.children[i2]);
                  if (renderedChild !== null) {
                    if (renderedChildren === null) {
                      renderedChildren = [renderedChild];
                    } else {
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var objectIs = typeof Object.is === "function" ? Object.is : is;
        var useState = React7.useState, useEffect2 = React7.useEffect, useLayoutEffect2 = React7.useLayoutEffect, useDebugValue2 = React7.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef3 = React7.useRef, useEffect2 = React7.useEffect, useMemo3 = React7.useMemo, useDebugValue2 = React7.useDebugValue;
        function useSyncExternalStoreWithSelector3(subscribe, getSnapshot, getServerSnapshot, selector2, isEqual) {
...
var testInterface = {
  butThen: async function(s2, thenCB, tr) {
...
function Provider({
  ...
  const previousState = React5.useMemo(() => store2.getState(), [store2]);
...
function createSelectorCreator(memoize) {
  ...
  var createSelector2 = function createSelector3() {
    ...
    var selector2 = memoize(function dependenciesChecker() {
      var params = [];
...
function LoginPage() {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", null, /* @__PURE__ */ import_react4.default.createElement("h2", null, "Welcome back!"), /* @__PURE__ */ import_react4.default.createElement("form", null, /* @__PURE__ */ import_react4.default.createElement("input", { type: "email", value: selection.email, onChange: (e) => store.dispatch(actions.setEmail(e.target.value)) }), /* @__PURE__ */ import_react4.default.createElement("p", { id: "invalid-email-warning", className: "warnin" }, selection.error === "invalidEmail" && emailwarning), /* @__PURE__ */ import_react4.default.createElement("br", null), /* @__PURE__ */ import_react4.default.createElement("input", { type: "password", value: selection.password, onChange: (e) => store.dispatch(actions.setPassword(e.target.value)) }), /* @__PURE__ */ import_react4.default.createElement("p", { id: "error" }, selection.error === "credentialFail" && "You entered an incorrect email, password, or both."), /* @__PURE__ */ import_react4.default.createElement("br", null), /* @__PURE__ */ import_react4.default.createElement("button", { disabled: selection.disableSubmit, onClick: (event) => {
    store.dispatch(actions.signIn());
  } }, "Sign In")), /* @__PURE__ */ import_react4.default.createElement("pre", null, JSON.stringify(selection, null, 2)));
}
function LoginPage_default() {
  return /* @__PURE__ */ import_react4.default.createElement(Provider_default, { store }, /* @__PURE__ */ import_react4.default.createElement(LoginPage, null));
}

// src/LoginPage/react-test-renderer/test.tsx
var import_react_test_renderer2 = __toESM(require_react_test_renderer(), 1);
