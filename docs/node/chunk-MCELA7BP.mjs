                      ...
                      return pages.map((page) => {
                        return new Proxy(page, {
                          get(pTarget, pProp, pReciever) {
                            if (pProp === "screenshot") {
                              return async (x) => {
                                return pm.customScreenShot(Object.assign(Object.assign({}, x), { path: `${testResourceConfiguration.fs}/suite-${sNdx}/beforeAll/` + x.path }), page);
                              };
                    ...
                    return pages.map((page) => {
                      return new Proxy(page, {
                        get(pTarget, pProp, pReciever) {
                          if (pProp === "screenshot") {
                            return async (x) => {
                              return pm.customScreenShot(Object.assign(Object.assign({}, x), { path: `${testResourceConfiguration.fs}/suite-${sNdx}/afterAll/` + x.path }));
                            };
                          } else if (pProp === "mainFrame") {
                            return () => pTarget[pProp]();
                          } else if (pProp === "close") {
                        ...
                        return pages.map((page) => {
                          return new Proxy(page, {
                            get(pTarget, pProp, pReciever) {
                              if (pProp === "screenshot") {
                                return async (x) => {
                                  return pm.customScreenShot(Object.assign(Object.assign({}, x), { path: `${testResourceConfiguration.fs}/suite-${suiteNdx}/given-${key}/afterEach/` + x.path }), page);
                                };
                              } else if (pProp === "mainFrame") {
                                return () => pTarget[pProp]();
                    ...
                    return pages.map((page) => {
                      return new Proxy(page, {
                        get(pTarget, pProp, pReciever) {
                          if (pProp === "screenshot") {
                            return async (x) => {
                              return pm.customScreenShot(Object.assign(Object.assign({}, x), { path: `${testResourceConfiguration.fs}/${key}/afterEach/` + x.path }), page);
                            };
                          } else if (pProp === "mainFrame") {
                            return () => pTarget[pProp]();
                          } else if (pProp === "exposeFunction") {
                      ...
                      return pages.map((page) => {
                        return new Proxy(page, {
                          get(pTarget, pProp, pReciever) {
                            if (pProp === "screenshot") {
                              return async (x2) => {
                                return pm.customScreenShot(Object.assign(Object.assign({}, x2), { path: `${testResourceConfiguration.fs}/${filepath}/butThen/` + x2.path }), page);
                              };
                            } else if (pProp === "close") {
                              return () => pTarget[pProp]();
                            } else if (pProp === "mainFrame") {
...
var Node_default = async (input, testSpecification, testImplementation, testInterface2, testResourceRequirement = defaultTestResourceRequirement) => {
