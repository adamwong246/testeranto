...
async function importDebug() {
  if (!debugModule) {
    debugModule = (await import("./src-KPDNDTP4.mjs")).default;
  }
  return debugModule;
}
var debug = (prefix) => {
...
init_cjs_shim();
var getFetch = async () => {
  return globalThis.fetch || (await import("./node-ponyfill-EITUOUP3.mjs")).fetch;
};

// ../testeranto/node_modules/puppeteer-core/lib/esm/puppeteer/common/BrowserConnector.js
var getWebSocketTransportClass = async () => {
  return isNode ? (await import("./NodeWebSocketTransport-FFMK3MOQ.mjs")).NodeWebSocketTransport : (await import("./BrowserWebSocketTransport-AHJZUB76.mjs")).BrowserWebSocketTransport;
};
