...
import { getFileService, type FileChange } from '../../services/FileService';
        ...
        <Col>
          ...
          {mode === 'static' && (
            <Alert variant="info" className="mt-2">
              <small>Static mode: Read-only access. Switch to Development mode for full Git functionality.</small>
            </Alert>
          )}
        </Col>
      </Row>
