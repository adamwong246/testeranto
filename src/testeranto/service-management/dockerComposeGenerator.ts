...
import { webDocker } from "./webDocker";
import { golangDocker } from "./golangDocker";
import { nodeDocker } from "./nodeDocker";
import { pythonDocker } from "./pythonDocker";
    ...
    for (const [testPath, testConfig] of Object.entries(tests)) {
      ...
      const serviceConfig: any = {
        ...
        environment: {
          ...
          DOCKERMAN_PORT: dockerManPort ? dockerManPort.toString() : "0",
          WEBSOCKET_PORT: webSocketPort ? webSocketPort.toString() : "0",
      ...
      // For web runtime, add Chromium dependency and environment variables
      if (runtime === "web") {
