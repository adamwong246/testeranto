  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ 
        ...
        {messages.length === 0 ? (
          <p style={{ color: "#666", fontStyle: "italic" }}>No messages yet. WebSocket messages will appear here.</p>
        ) : (
          <div>
                  ...
                  {msg.logs && msg.logs.length > 0 && (
                    <div style={{ 
                      ...
                      {msg.logs.map((log: string, index: number) => (
                        <div key={index} style={{ 
                          padding: "2px 0",
                          borderBottom: index < msg.logs.length - 1 ? "1px solid #ddd" : "none",
      ...
      <div style={{ marginTop: "20px", fontSize: "12px", color: "#666" }}>
        <p>This is a simple WebSocket monitor to verify WebSocket connectivity.</p>
        <p>Messages are displayed in real-time as they arrive from the server.</p>
      </div>
    </div>
  );
};
