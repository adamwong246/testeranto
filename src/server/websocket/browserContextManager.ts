...
export class BrowserContextManager {
  ...
  async initialize(): Promise<void> {
    ...
    console.error('Failed to connect to Chrome via any endpoint after', maxRetries, 'attempts');
    throw new Error(`Could not connect to Chrome. Make sure the chromium service is running at ${chromeHost}:${chromePort}. Last error: ${lastError?.message}`);
  }
