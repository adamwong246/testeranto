...
/**
 * Get static analysis commands based on runtime (pure version)
 * This is a simplified implementation that doesn't depend on configs
 */
export function getStaticAnalysisCommandPure(
  testName: string,
  runtime: IRunTime
): string | null {
...
/**
 * Generate Docker command for static analysis (pure string generation)
 */
