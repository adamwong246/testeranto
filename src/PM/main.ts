...
export class PM_Main extends PM_WithGit {
  ...
  constructor(configs: IBuiltConfig, name: string, mode: "once" | "dev") {
    ...
    // Setup WebSocket server for Git integration
...
<body>
  ...
  private handleWebSocketMessage(message: any, ws: WebSocket) {
    switch (message.type) {
      case "get-initial-state":
        ...
        break;
      case "file-changed":
        // File was changed, refresh Git status
