...
//   // Reference to the parent Tiposkripto instance for WebSocket communication
//   private parent: any;

//   constructor(t: ITTestResourceConfiguration, parent: any) {
//     super();
...
//     // Delegate to parent's sendCommand method
//     if (this.parent && this.parent.sendCommand) {
//       return this.parent.sendCommand(command, ...argz);
//     } else {
//       return Promise.reject(new Error("Parent Tiposkripto instance not available for WebSocket communication"));
//     }
//   }
