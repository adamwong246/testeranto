...
// myTests/solidity/solidity.testeranto.test.ts
var SolidityTesteranto = (testImplementations, testSpecifications, testInput) => __async(void 0, null, function* () {
  ...
  return Testeranto(
    ...
    { ports: 0 },
    {
      ...
      beforeEach: (contract) => __async(void 0, null, function* () {
        ...
        return {
          contract: yield new web3.eth.Contract(contract.abi).deploy({
      ...
      andWhen: (_0, _1) => __async(void 0, [_0, _1], function* ({ provider, contract, accounts }, callback) {
...
var MyFirstContractTesteranto = SolidityTesteranto(
  {
    ...
    Thens: {
      Get: ({ asTestUser, expectation }) => (_0) => __async(void 0, [_0], function* ({ contract, accounts }) {
        return assert.equal(expectation, parseInt(yield contract.methods.get().call()));
      })
    },
    Checks: {
  ...
  ["MyFirstContract", (web3) => __async(void 0, null, function* () {
    return [];
  })]
  // 'MyFirstContract'
);
