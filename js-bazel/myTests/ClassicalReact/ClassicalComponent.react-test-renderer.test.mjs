...
var ReactTestRendererTesteranto = (testImplementations, testSpecifications, testInput, nameKey) => core_node_default(
  testInput,
  testSpecifications,
  testImplementations,
  {
    beforeEach: function(CComponent, props) {
      ...
      (0, import_react_test_renderer.act)(() => {
        component = import_react_test_renderer.default.create(
          import_react2.default.createElement(CComponent, props, [])
        );
      });
      return component;
    },
...
// myTests/ClassicalReact/ClassicalComponent.test.ts
