// a very crude test of an http server which exists mostly as a POC.
// It can only POST and GET via WHEN and THEN, and it can only check the equality of that response.
