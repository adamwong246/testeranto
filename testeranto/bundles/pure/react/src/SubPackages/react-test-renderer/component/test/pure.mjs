...
var require_scheduler_production_min = __commonJS({
  "node_modules/scheduler/cjs/scheduler.production.min.js"(exports) {
    ...
    exports.unstable_forceFrameRate = function(a) {
      0 > a || 125 < a ? void 0 : P = 0 < a ? Math.floor(1e3 / a) : 5;
    };
    exports.unstable_getCurrentPriorityLevel = function() {
      return y;
    };
...
var Pure_default = async (input, testSpecification, testImplementation2, testInterface2, testResourceRequirement = defaultTestResourceRequirement) => {
...
// src/SubPackages/react-test-renderer/component/pure.ts
var pure_default = (testImplementations, testSpecifications, testInput) => Pure_default(
  testInput,
  testSpecifications,
  testImplementations,
  testInterface
...
var ClassicalComponent = class extends React2.Component {
  ...
  render() {
    return /* @__PURE__ */ React2.createElement("div", { style: { border: "3px solid black" } }, /* @__PURE__ */ React2.createElement("h1", { id: "theHeader" }, "Hello Marcus"), /* @__PURE__ */ React2.createElement("pre", { id: "theProps" }, JSON.stringify(this.props)), /* @__PURE__ */ React2.createElement("p", null, "foo: ", this.props.foo), /* @__PURE__ */ React2.createElement("pre", { id: "theStat" }, JSON.stringify(this.state)), /* @__PURE__ */ React2.createElement("p", null, "count: ", this.state.count, " times"), /* @__PURE__ */ React2.createElement(
      "button",
      {
        id: "theButton",
        onClick: async () => {
