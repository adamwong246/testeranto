...
var testeranto = async (input, testSpecification, testImplementation2, testInterface2, testResourceRequirement = defaultTestResourceRequirement) => {
...
var node_default = (testImplementations, testSpecifications, testInput) => Node_default(
  testInput,
  testSpecifications,
  testImplementations,
  testInterface
