...
// src/tiposkripto/BaseTiposkripto.ts
import WebSocket from "ws";

// src/tiposkripto/BaseGiven.ts
var BaseGiven = class {
...
var BaseTiposkripto = class {
  constructor(input, testSpecification, testImplementation, testResourceRequirement = defaultTestResourceRequirement, testAdapter = {}, analyzer) {
    ...
    this.testJobs = this.specs.map((suite) => {
      const suiteRunner = (suite2) => async (testResourceConfiguration) => {
        try {
...
// src/tiposkripto/Web.ts
var WebTiposkripto = class extends BaseTiposkripto {
  constructor(input, testSpecification, testImplementation, testResourceRequirement, testAdapter, webSocketPort) {
    super(
      input,
      testSpecification,
      testImplementation,
  ...
  async receiveTestResourceConfig(testResourceConfiguration) {
