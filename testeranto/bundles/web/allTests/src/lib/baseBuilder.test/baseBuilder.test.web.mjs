...
var BaseGiven = class {
  constructor(name2, features2, whens, thens, givenCB, initialValues) {
    this.name = name2;
...
var BaseCheck = class {
  constructor(name2, features2, checker, x, checkCB) {
    this.name = name2;
    this.features = features2;
...
var BaseSuite = class {
  constructor(name2, index, givens = {}, checks = []) {
    this.name = name2;
    this.index = index;
    this.givens = givens;
    this.checks = checks;
  ...
  constructor(input, testSpecification, testImplementation, testResourceRequirement = defaultTestResourceRequirement, testInterface2, uberCatcher) {
    ...
    super(
      ...
      class Check extends BaseCheck {
        constructor(name2, features2, checkCallback, x, i, c) {
          super(name2, features2, checkCallback, x, c);
...
function dew$j2() {
  ...
  function isFinished(stream, opts2) {
    if (!isNodeStream(stream)) {
      return null;
    }
    if (isDestroyed(stream)) {
    ...
    if ((opts2 === null || opts2 === void 0 ? void 0 : opts2.readable) !== false && isReadable(stream)) {
      return false;
    }
    if ((opts2 === null || opts2 === void 0 ? void 0 : opts2.writable) !== false && isWritable(stream)) {
      return false;
    }
    return true;
  }
...
function dew$i2() {
  ...
  function finished2(stream, opts2) {
    var _opts;
    let autoCleanup = false;
    if (opts2 === null) {
      opts2 = kEmptyObject;
    }
    if ((_opts = opts2) !== null && _opts !== void 0 && _opts.cleanup) {
      validateBoolean(opts2.cleanup, "cleanup");
      autoCleanup = opts2.cleanup;
    }
    return new Promise2((resolve, reject) => {
      const cleanup = eos(stream, opts2, (err) => {
        if (autoCleanup) {
          cleanup();
        }
        if (err) {
...
function dew$53() {
  ...
  function pipelineImpl(streams, callback, opts2) {
    ...
    const ac = new AbortController();
    const signal = ac.signal;
    const outerSignal = opts2 === null || opts2 === void 0 ? void 0 : opts2.signal;
    ...
    for (let i = 0; i < streams.length; i++) {
      ...
      const writing = i > 0;
      const end = reading || (opts2 === null || opts2 === void 0 ? void 0 : opts2.end) !== false;
...
function dew$33() {
  ...
  async function reduce(reducer, initialValue, options) {
    ...
    if (options !== null && options !== void 0 && options.signal) {
      ...
      options.signal.addEventListener("abort", () => ac.abort(), opts2);
    }
